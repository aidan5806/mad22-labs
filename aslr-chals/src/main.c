...
// Put the thread into a seccomp-bpf jail such that it can only make a limited number of syscalls
// So you can't open proc self maps or anything ;)
void setup_jail() {
	struct sock_filter filter[] = {
		...
		// access() will not be allowed for the prefetch jail!
#ifdef MAD_EGGHUNTER
